      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <button onClick={() => scrollToSection('design-plans')} className={`${isScrolled ? 'text-black' : 'text-white'} font-bold px-4 py-2 hover:text-blue-600 transition-colors`}>
              Plans
            </button>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <nav className="flex flex-col space-y-4">
              ...
              <button onClick={() => scrollToSection('design-plans')} className="text-left text-gray-700 hover:text-blue-600 transition-colors">
                Plans
              </button>
