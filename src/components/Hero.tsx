        ...
        >
          ...
          >
            ...
            <Button
              ...
              variant="outline"
              className="border-white bg-white text-orange-500 hover:border-orange-500 hover:bg-orange-500 hover:text-white px-8 py-3 text-lg rounded-lg transition-all duration-300"
            >
              View Our Work
            </Button>
          </motion.div>
